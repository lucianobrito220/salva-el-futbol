...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 z-30 w-full max-w-[440px] -translate-x-1/2 border-t border-charcoal-line bg-charcoal px-1.5 pb-[max(8px,env(safe-area-inset-bottom))] pt-2">
      <div className="flex">
        {items.map((item) => {
